...
object GrokConfig {
    // Prompts for xAI API
    const val SONG_LIST_PROMPT = "Yo Grok, you my DJ! Gimme a list of %d songs for %s. %s%s%s%s%s DO NOT INCLUDE these tracks: %s. If too few tracks match, fill with similar vibe/genre matches. Format: 'Artist - Title', one per line. No intros, no fluff, just the list."
    ...
    const val MAX_EXCLUDED_URIS = 200
